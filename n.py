...
REQUIRED_SUBSCRIPTIONS = [
    {
        "chat_id": "@solarwar_channel",  # آیدی کانال/گروه اول
        "link": "https://t.me/solarwar_channel",
        "label": "کانال",
    },
]
DEFENSE_ITEMS = [
...
REDLINE_WHEEL_CHANCES = [1, 2, 3, 10, 15, 25, 35]
